#ifndef CATERM_DEMOS_PALETTE_COLOR_DISPLAY_PANEL_HPP
#define CATERM_DEMOS_PALETTE_COLOR_DISPLAY_PANEL_HPP
...
#endif  // CATERM_DEMOS_PALETTE_COLOR_DISPLAY_PANEL_HPP
