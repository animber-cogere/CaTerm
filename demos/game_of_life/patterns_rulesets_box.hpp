#ifndef CATERM_DEMOS_GAME_OF_LIFE_PATTERNS_RULESETS_BOX_HPP
#define CATERM_DEMOS_GAME_OF_LIFE_PATTERNS_RULESETS_BOX_HPP
#include <string>
#include <utility>
...
#endif  // CATERM_DEMOS_GAME_OF_LIFE_PATTERNS_RULESETS_BOX_HPP
