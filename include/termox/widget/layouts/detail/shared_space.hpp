#ifndef CATERM_WIDGET_LAYOUTS_DETAIL_SHARED_SPACE_HPP
#define CATERM_WIDGET_LAYOUTS_DETAIL_SHARED_SPACE_HPP
#include <cstddef>
#include <vector>
...
#endif  // CATERM_WIDGET_LAYOUTS_DETAIL_SHARED_SPACE_HPP
