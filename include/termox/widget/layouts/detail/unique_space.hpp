#ifndef CATERM_WIDGET_LAYOUTS_DETAIL_UNIQUE_SPACE_HPP
#define CATERM_WIDGET_LAYOUTS_DETAIL_UNIQUE_SPACE_HPP
#include <cstddef>
#include <utility>
#include <vector>
...
#endif  // CATERM_WIDGET_LAYOUTS_DETAIL_UNIQUE_SPACE_HPP
