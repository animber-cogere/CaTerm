#ifndef CATERM_WIDGET_LAYOUTS_DETAIL_LAYOUT_SPAN_HPP
#define CATERM_WIDGET_LAYOUTS_DETAIL_LAYOUT_SPAN_HPP
#include <algorithm>
#include <cstddef>
#include <iterator>
#include <numeric>
...
#endif  // CATERM_WIDGET_LAYOUTS_DETAIL_LAYOUT_SPAN_HPP
