#ifndef CATERM_WIDGET_WIDGETS_DETAIL_TEXTLINE_CORE_HPP
#define CATERM_WIDGET_WIDGETS_DETAIL_TEXTLINE_CORE_HPP
#include <algorithm>
#include <cassert>
#include <iterator>
...
#endif  // CATERM_WIDGET_WIDGETS_DETAIL_TEXTLINE_CORE_HPP
