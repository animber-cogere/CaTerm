#ifndef CATERM_WIDGET_WIDGETS_DETAIL_TEXTBOX_BASE_HPP
#define CATERM_WIDGET_WIDGETS_DETAIL_TEXTBOX_BASE_HPP
#include <cstddef>
#include <utility>
...
#endif  // CATERM_WIDGET_WIDGETS_DETAIL_TEXTBOX_BASE_HPP
