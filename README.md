...
**CaTerm Color Palettes** support full true color with RGB and HSL values,
...
value at a given time interval. CaTerm comes with Rainbow and Fade Dynamic Color
...
There are two ways of building applications in CaTerm; with types or values. The
